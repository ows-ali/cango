...
import {
  languages, scenarios, levels, scenarioLevels, modules,
} from "../src/lib/db/schema";
import { addExperience } from "./seed-helpers";
import { seedTransportation } from "./seed-transportation";
import { seedDoctor } from "./seed-doctor";
import { seedJobInterview } from "./seed-job-interview";
import { seedA1 } from "./seed-a1";
import { seedRestaurant } from "./seed-restaurant";
import { seedShopping } from "./seed-shopping";
import { seedHotel } from "./seed-hotel";
import { seedEmergency } from "./seed-emergency";
